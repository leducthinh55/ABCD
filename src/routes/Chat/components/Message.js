...
export default ({ msg, isNextMsg, lastMsg, classes, incomingMsgColor, outcomingMsgColor }) => (
    <div
        style={{
    ...
    >
        {lastMsg ? (
            <div
                className={`${msg.incoming ? classes.lastMsgIncoming : classes.lastMsgOutcoming}`}
                style={{
                    borderColor: `${
                        msg.incoming
